  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">{t("notFound.title", "Page not found")}</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("notFound.text", "The page you're looking for doesn't exist or has been moved.")}
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          {t("error.loadTitle", "This page didn't load")}
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("error.loadText", "Something went wrong on our end. You can try refreshing or head back home.")}
        </p>
